...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { SteelBlocksArr: SteelIntialData, GrassBlocksArr:GrassInitialData, WallsBlockArr: WallsInitData, WaterBlockArr: WaterIntialData, EnemyBasicTankArr: enemyTankConfig, EnemyTankType2Arr: enemyType2Config, Player: PlayerInitData  } =  parseInitEnvDataToGameWorld(GameLevel2Setup);
